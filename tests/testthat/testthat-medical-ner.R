...
#   test_annotator <- nlp_medical_ner(sc, input_cols = c("sentence", "token", "embeddings"), output_col = "ner", label_col = "label")
...
#   test_annotator <- nlp_medical_ner(pipeline, input_cols = c("sentence", "token", "embeddings"), output_col = "ner", label_col = "label")
...
#   fit_model <- nlp_medical_ner(train_data, input_cols = c("sentence", "token", "embeddings"), output_col = "ner", label_col = "label")
#   expect_equal(invoke(spark_jobj(fit_model), "getOutputCol"), "ner")
# })
