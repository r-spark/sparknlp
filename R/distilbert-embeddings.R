#' Spark NLP DistilBertEmbeddings
#'
...
#' 
#' @export
nlp_distilbert_embeddings <- function(x, input_cols, output_col,
  ...
  UseMethod("nlp_distilbert_embeddings")
}

#' @export
nlp_distilbert_embeddings.spark_connection <- function(x, input_cols, output_col,
                 batch_size = NULL, case_sensitive = NULL, dimension = NULL, 
                 max_sentence_length = NULL, output_annotator_type = NULL, storage_ref = NULL, 
                 uid = random_string("distilbert_embeddings_")) {
  args <- list(
  ...
  jobj <- sparklyr::spark_pipeline_stage(
    x, "com.johnsnowlabs.nlp.embeddings.DistilBertEmbeddings",
  ...
  new_nlp_distilbert_embeddings(jobj)
}

#' @export
nlp_distilbert_embeddings.ml_pipeline <- function(x, input_cols, output_col,
                 batch_size = NULL, case_sensitive = NULL, dimension = NULL, 
                 max_sentence_length = NULL, storage_ref = NULL,
                 uid = random_string("distilbert_embeddings_")) {

  stage <- nlp_distilbert_embeddings.spark_connection(
...
#' @export
nlp_distilbert_embeddings.tbl_spark <- function(x, input_cols, output_col,
                 batch_size = NULL, case_sensitive = NULL, dimension = NULL, 
                 max_sentence_length = NULL, storage_ref = NULL, 
                 uid = random_string("distilbert_embeddings_")) {
  stage <- nlp_distilbert_embeddings.spark_connection(
...
nlp_float_params.nlp_distilbert_embeddings <- function(x) {
  return(c())
}
