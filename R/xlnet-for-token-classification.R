#' Spark NLP XlnetForTokenClassification
#'
#' XlnetForTokenClassification can load XLNet Models with a token classification head on top 
...
#' 
#' @export
nlp_xlnet_token_classification_pretrained <- function(sc, input_cols, output_col,
  ...
  args <- list(
    ...
    validator_nlp_xlnet_token_classification()
  
  model_class <- "com.johnsnowlabs.nlp.annotators.classifier.dl.XlnetForTokenClassification"
...
#' @import forge
validator_nlp_xlnet_token_classification <- function(args) {
...
new_nlp_xlnet_for_token_classification <- function(jobj) {
  sparklyr::new_ml_transformer(jobj, class = "nlp_xlnet_for_token_classification")
}
