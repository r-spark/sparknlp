...
#' 
#' @export
nlp_bert_for_token_classification <- function(x, input_cols, output_col,
                 batch_size = NULL, case_sensitive = NULL, max_sentence_length = NULL,
                 uid = random_string("bert_for_token_classification_")) {
  UseMethod("nlp_bert_for_token_classification")
}

#' @export
nlp_bert_for_token_classification.spark_connection <- function(x, input_cols, output_col,
                 batch_size = NULL, case_sensitive = NULL, max_sentence_length = NULL,
                 uid = random_string("bert_for_token_classification_")) {
  args <- list(
  ...
  validator_nlp_bert_for_token_classification()

  jobj <- sparklyr::spark_pipeline_stage(
    x, "com.johnsnowlabs.nlp.annotators.classifier.dl.BertForTokenClassification",
  ...
  new_nlp_bert_for_token_classification(jobj)
}

#' @export
nlp_bert_for_token_classification.ml_pipeline <- function(x, input_cols, output_col,
                 batch_size = NULL, case_sensitive = NULL, max_sentence_length = NULL,
                 uid = random_string("bert_for_token_classification_")) {

  stage <- nlp_bert_for_token_classification.spark_connection(
...
#' @export
nlp_bert_for_token_classification.tbl_spark <- function(x, input_cols, output_col,
                 batch_size = NULL, case_sensitive = NULL, max_sentence_length = NULL,
                 uid = random_string("bert_for_token_classification_")) {
  stage <- nlp_bert_for_token_classification.spark_connection(
    x = sparklyr::spark_connection(x),
...
#' @import forge
validator_nlp_bert_for_token_classification <- function(args) {
...
nlp_float_params.nlp_bert_for_token_classification <- function(x) {
  return(c())
}
